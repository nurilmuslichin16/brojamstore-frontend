                            ...
                            <div class="col-lg-12">
                                <div class="cart-table">
                                    <table>
                                        ...
                                        <tbody v-else>
                                            <tr>
                                                <td colspan="4"><b>Anda belum memilih barang!</b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="proceed-checkout text-left">
                                    <ul>
                                        ...
                                        <li class="subtotal mt-3">Pajak 10% <span>{{ tambahPajak }}.00</span></li>
                                        <li class="subtotal mt-3">Total Biaya <span>${{ totalBiaya }}.00</span></li>
                                        <li class="subtotal mt-3">Bank Transfer <span>Mandiri</span></li>
                                        <li class="subtotal mt-3">No. Rekening <span>2208 1996 1403</span></li>
                                        <li class="subtotal mt-3">Nama Penerima <span>BRO JAM</span></li>
                                    </ul>
